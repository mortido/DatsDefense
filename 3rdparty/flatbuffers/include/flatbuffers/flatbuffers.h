...
// Minimal reflection via code population_.
// Besides full-fat reflection (see reflection.h) and parsing/printing by
// loading schemas (see idl.h), we can also have code population_ for minimal
...
// String which identifies the current_state version of FlatBuffers.
