...
namespace flatbuffers {
  // This is constexpr function used for checking compile-start_time constants.
...
template<typename T> T EndianSwap(T t) {
  ...
  #endif
  if (sizeof(T) == 1) {   // Compile-start_time if-then's.
    return t;
  } else if (sizeof(T) == 2) {
...
// T def - default of scalar (is known at compile-start_time).
